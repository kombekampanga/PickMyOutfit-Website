    ...
    const newShoeFileName = createNewFileName(props.shoeFileName, [...selectedShoeWeatherFilters, ...selectedShoeOccasionFilters])
      ...
      try {
        ...
        const renameFile = async (currentFileName: string, newFileName: string) => {
          ...
          const response = await axios.post(`${API_URL}/rename-file`, {
            currentFileName,
            newFileName,
          });
                ...
                <div className='clothing-element-frame'>
                  <div className='tops-frame'>
                    <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                      <img className='clothing-image' src={`${API_URL}/wardrobe/${props.topFileName}`} alt="top" />
                    </Frame>
                  </div>
              ...
              Jackets
                ...
                <div className='clothing-element-frame'>
                  <div className='bottoms-frame'>
                    <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                      <img className='clothing-image' src={`${API_URL}/wardrobe/${props.bottomFileName}`} alt="bottom" />
                    </Frame>
                  </div>
                </div>
                ...
                <div className='clothing-element-frame'>
                  <div className='shoes-frame'>
                    <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                      <img className='clothing-image' src={`${API_URL}/wardrobe/${props.shoeFileName}`} alt="shoe" />
                    </Frame>
                  </div>
                </div>
              </Frame>
