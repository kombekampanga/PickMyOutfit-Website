...
export default function WardropeApp(props: WardrobeProps) {
    ...
    useEffect(() => {
      const fetchWardrobe = async () => { 
        try {
          const response = await axios.get(`${API_URL}/getExistingWardrobe`)
                ...
                <div className='tops-frame'>
                  <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                    <img 
                      ...
                      src={`${API_URL}/wardrobe/${currentTops[currentTopIndex]}`} 
                      alt="top" 
              ...
              <div className='clothing-element-frame'>
                ...
                <div className='bottoms-frame'>
                  <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                    <img 
                      className='clothing-image' 
                      src={`${API_URL}/wardrobe/${currentBottoms[currentBottomIndex]}`} 
                      alt="bottom" 
              ...
              <div className='clothing-element-frame'>
                ...
                <div className='shoes-frame'>
                  <Frame w="100%" h="100%" bgColor="$material" boxShadow="$out" padding="$4">
                    <img 
                      className='clothing-image' 
                      src={`${API_URL}/wardrobe/${currentShoes[currentShoeIndex]}`} 
                      alt="shoe" 
